...
namespace Drupal\lost_character_captcha\Tests;
 ...
 * @group captcha
 */
class LostCharacterCaptchaTestCase extends CaptchaBaseWebTestCase {
  ...
  public function testAsciiArtCaptchaOnLoginForm() {
    ...
    $captcha_point->setCaptchaType('lost_character_captcha/Lost characters');
    ...
    $this->assertText(self::CAPTCHA_WRONG_RESPONSE_ERROR_MESSAGE, 'Lost character CAPTCHA should block user login form', 'CAPTCHA');
