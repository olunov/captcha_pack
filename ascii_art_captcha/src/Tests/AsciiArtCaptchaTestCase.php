...
namespace Drupal\ascii_art_captcha\Tests;
 ...
 * @group captcha
 */
class AsciiArtCaptchaTestCase extends CaptchaBaseWebTestCase {
  ...
  public function testAsciiArtCaptchaOnLoginForm() {
    ...
    $captcha_point->setCaptchaType('ascii_art_captcha/ASCII art CAPTCHA');
    ...
    $this->assertText(self::CAPTCHA_WRONG_RESPONSE_ERROR_MESSAGE, 'Ascii art CAPTCHA should block user login form', 'CAPTCHA');
  ...
  public function testAsciiArtCaptchaSessionReuseOnNodeForms() {
    ...
    captcha_set_form_id_setting('node_page_form', 'ascii_art_captcha/Test');
  ...
  public function testAjaxFormRebuild() {
    ...
    \Drupal::entityManager()->getStorage('captcha_point')->create([
      ...
      'formId' => 'user_form',
      'status' => TRUE,
      'captchaType' => 'ascii_art_captcha/ASCII art CAPTCHA',
    ])->save();
